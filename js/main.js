...
$('.item.02-c-03').mousedown(function(){
	window.open('items/02/C/03/index.html','itemWindow', windowAttr)
})

$('.item.02-c-04').mousedown(function(){
	window.open('items/02/C/04/index.html','itemWindow', windowAttr)
})

$('.item.02-c-05').mousedown(function(){
	window.open('items/02/C/05/index.html','itemWindow', windowAttr)
})
...
$('.item.03-a-02').mousedown(function(){
	window.open('items/03/A/02/index.html','itemWindow', windowAttr)
})
...
for (var i = 0; i < 801; i++) {
	var img = $('<img src="artifacts' + (i + 1) + '.jpeg">')
	$('#human-artifacts').append(img);
}
...
for (var i = 0; i < 213; i++) {
	var img = $('<img src="jaffe' + (i + 1) + '.jpeg">')
	$('#jaffe').append(img);
}



// ADDING ESSENTIALLY ANONYMOUS IMAGES

for (var i = 0; i < 81; i++) {
	var img = $('<img src="anon' + (i + 1) + '.jpg">')
	$('#anon').append(img);
}



// ADDING COLORIZED PORTRAIT IMAGES

for (var i = 0; i < 9; i++) {
	var img = $('<img src="colorized' + (i + 1) + '.jpg">')
	$('#color').append(img);
}



// ADDING AMNH MUSEUM AND DISPLAY IMAGES

for (var i = 0; i < 133; i++) {
	var img = $('<img src="museum' + (i + 1) + '.jpg">')
	$('#museum').append(img);
}
